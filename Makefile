main: main.o alphablend.o
	@g++ -o $@ $^ -lsfml-graphics -lsfml-window -lsfml-system
	./$@

main.o: main.cpp alphablend.hpp
	@g++ -c -o $@ $< $(FLAGS) 

alphablend.o: alphablend.cpp alphablend.hpp
	@g++ -c -o $@ $< $(FLAGS)
...
FLAGS = -O3 -Wshadow -Winit-self -Wredundant-decls -Wcast-align -Wundef -Wfloat-equal -Winline -Wunreachable-code\
		...
		-Wwrite-strings -D_DEBUG -D_EJUDGE_CLIENT_SIDE -mavx2